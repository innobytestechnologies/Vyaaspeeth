...
class dashboard_live(models.Model):
...
class stripeUser_live(models.Model):
...
def  stripeCallback_live(sender,request,user,**kwargs):
...
def  dashboardCallback_live(sender,request,user,**kwargs):
...
user_logged_in.connect(stripeCallback_live)
user_signed_up.connect(dashboardCallback_live)
user_signed_up.connect(stripeCallback_live)
